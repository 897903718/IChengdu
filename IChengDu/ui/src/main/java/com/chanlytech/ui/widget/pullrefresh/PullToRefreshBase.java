...
import com.chanlytech.ui.widget.pullrefresh.internal.BridLoadingLayout;
    ...
    public static enum AnimationStyle
    {
        ...
        LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs)
        {
            switch (this)
            {
                case ROTATE:
                default://更改刷新控件顶部动画
                   // return new RotateLoadingLayout(context, mode, scrollDirection, attrs);//旋转动画
                    return  new BridLoadingLayout(context,mode,scrollDirection,attrs);//帧动画
                case FLIP:
