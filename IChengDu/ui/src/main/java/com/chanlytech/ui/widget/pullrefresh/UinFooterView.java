...
public class UinFooterView extends LinearLayout
{
    ...
    public UinFooterView(Context context)
    {
        super(context);
        initView(context);
    }

    public UinFooterView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initView(context);
    }
    ...
    {
        mLayout = LayoutInflater.from(context).inflate(R.layout.uin_footer, null);
    ...
    public void setState(int state)
    {
        ...
        switch (state)
        {
            ...
            case STATE_NO_DATA:
                if (mState != STATE_READY)
                {
                    mHintView.setText(R.string.footer_hint_load_no_data);
                }
                break;
        }
