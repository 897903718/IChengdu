 ...
 * Created by Carlton on 2014/10/10.
 */
public abstract class CycleFragmentPagerAdapter extends PagerAdapter
{
    ...
    {
        mFragmentManager = fm;
        mBaseAdapterHelper = new BaseAdapterHelper(data == null ? 0 : data.size());
    }
    ...
    public int getCount()
    {
        return mBaseAdapterHelper.getCount();
    }

    public void autoScroll(ViewPager viewPager, int delay, long period)
    {
        mBaseAdapterHelper.autoScroll(viewPager, delay, period);
    }

    public void cancelScroll()
    {
        mBaseAdapterHelper.cancelScroll();
    }
    ...
    {
        return mBaseAdapterHelper.getPosition(position);
    }

    public int getFirstItemPosition()
    {
        return mBaseAdapterHelper.getFirstItemPosition();
    }
