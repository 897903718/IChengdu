...
public class UinHeaderView extends LinearLayout
{
    ...
    public UinHeaderView(Context context)
    {
        super(context);
        initView(context);
    }

    public UinHeaderView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initView(context);
    }
    ...
    private void initView(Context context)
    {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.uin_header, null);
