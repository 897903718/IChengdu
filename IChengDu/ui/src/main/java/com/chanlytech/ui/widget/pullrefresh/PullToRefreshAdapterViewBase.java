...
import com.chanlytech.ui.widget.pullrefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements OnScrollListener
{
     ...
     * {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase.Mode#PULL_FROM_START}. The default value is <var>true</var> if
     * {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase#isPullToRefreshOverScrollEnabled()
    ...
    /**
     * Pass-through method for {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase#getRefreshableView()
     * getRefreshableView()}.
     ...
     * a state where a Pull-to-Refresh can happen. An example of this state is
     * when the Adapter View is scrolled to the top and the mode is set to
     * {@link com.chanlytech.ui.widget.pullrefresh.PullToRefreshBase.Mode#PULL_FROM_START}
     *
     * @param showIndicator
