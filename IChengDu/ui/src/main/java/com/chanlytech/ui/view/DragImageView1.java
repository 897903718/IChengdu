 ...
 * @author iaiai
 */
public class DragImageView1 extends ImageView
{
     ...
     * 构造方法 *
     */
    public DragImageView1(Context context)
    {
        super(context);
    }
    ...
    public DragImageView1(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    }
